...
<body>
<h1 style="display:none" id="username">${user.username }</h1>
<!-- Header Area start  -->
            ...
            <div class="row align-self-center">
                ...
                <div class="col-auto align-self-center">
                    <div class="header-logo">
                        <a href="index"><img src="../assets/images/logo/logo.png" alt="Site Logo" /></a>
                    </div>
                </div>
                <!-- Header Logo End -->
                    ...
                    <div class="header-actions">
                        <div class="header_account_list">
                            ...
                            <div class="dropdown_search">
                                <form class="action-form" action="#">
                                    <input class="form-control" placeholder="请输入搜索关键字" type="text">
                        ...
                        <div class="header-bottom-set dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a class="dropdown-item" href="my-account?username=${user.username}">个人中心</a></li>
                                <li><a class="dropdown-item" href="order?username=${user.username}">我的订单</a></li>
                                <c:if test="${user==null}">
                                    <li><a class="dropdown-item" href="login">登录</a></li>
                                </c:if>
                                <c:if test="${user!=null}">
                                    <li><a class="dropdown-item" href="login_out">退出</a></li>
                                </c:if>
                            </ul>
                        </div>
                        <!-- Single Wedge End -->
                ...
                <div class="col-md-12 align-self-center">
                    <div class="main-menu manu-color-white">
                        <ul>
                            ...
                            <li class="dropdown position-static"><a href="shop_list">Shop <i
                                ...
                                <ul class="mega-menu d-block">
                                    <li class="d-flex">
                                        ...
                                        <ul class="d-block">
                                            ...
                                            <li><a href="order">Checkout Page</a></li>
...
<div id="offcanvas-cart" class="offcanvas offcanvas-cart">
    <div class="inner">
        ...
        <c:if test="${cartnum gt 0}">
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    <c:forEach items="${cartList}" var="list">
                        <li>
                            <a href="../system/shop_product?username=${user.username}&pid=${list.pid}" class="image"><img src="${list.photo}" alt="Cart product Image"></a>
                            <div class="content">
                                <a href="../system/shop_product?username=${user.username}&pid=${list.pid}" class="title">${list.product}</a>
                            </div>
                            <button onclick="delCart(${list.id})" class="remove" style="font-size: 20px;margin-left: 10px">×</button>
                        </li>
                    </c:forEach>
                </ul>
            </div>
        </c:if>
        <c:if test="${cartnum==null}">
            <h2 style="color: #d4c8c8;margin:100px auto">此处空空如也</h2>
        </c:if>
        <c:if test="${cartnum eq 0}">
            <h2 style="color: #d4c8c8;margin:100px auto">此处空空如也</h2>
        </c:if>
    </div>
</div>
...
<div class="section ">
    <div class="hero-slider swiper-container slider-nav-style-1 slider-dot-style-1 dot-color-white">
        ...
        <div class="swiper-wrapper">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8 offset-2 align-self-center m-auto">
                            <div class="hero-slide-content hero-slide-content-2 slider-animated-1 text-center">
                                ...
                                <a href="/system/shop_list" class="btn btn-lg btn-primary btn-hover-dark mt-5">查看更多</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Single slider item -->
            <div class="hero-slide-item slider-height-2 swiper-slide d-flex text-center" style="font-color:black">
                <div class="hero-bg-image">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8 offset-2 align-self-center m-auto">
                            <div class="hero-slide-content hero-slide-content-2 slider-animated-1">
                                ...
                                <a href="/system/shop_list?username=${user.username}" class="btn btn-lg btn-primary btn-hover-dark mt-5">查看更多</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 mb-md-30px mb-lm-30px" data-aos="fade-up" data-aos-delay="200">
                            <div class="single-wedge">
                                ...
                                <p class="about-text">This system is completed by Wu Zefeng and Chen Limin</p>
                        ...
                        <div class="col-md-6 col-lg-2 col-sm-6 mb-lm-30px" data-aos="fade-up" data-aos-delay="600">
                            <div class="single-wedge">
                                ...
                                <div class="footer-links">
                                    <div class="footer-row">
                                        <ul class="align-items-center">
                                            <li class="li"><a class="single-link" href="my-account">My
                                                    Account</a>
                                            </li>
                                            <li class="li"><a class="single-link" href="cart">My Cart</a></li>
                ...
                <div class="container">
                    <div class="row flex-sm-row-reverse">
                        ...
                        <div class="col-md-6 text-left">
                            <p class="copy-text">Copyright © 2021 <a class="company-name" href="#">
                                    Wuxg</a>. All Rights Reserved</p>
                        </div>
                    </div>
                </div>
            </div>
...
function toproduct() {
	$.ajax({
		type: "post",
		url: "shop_product?sid=101&username="+username,
		dataType: "json", //返回数据类型
		success: function(data){
			if("success" == data.type){
				window.parent.location.href = "toproduct";
			} 
			else{
				window.parent.location.href = "toproduct";
			}
...
function delCart(cid) {
    $.ajax({
        url: "../cart/delCart?cid="+cid+"&username="+username,
        type: "POST",
        dataType: "json", //返回数据类型
        success: function(data){
            if("success" == data.type){
